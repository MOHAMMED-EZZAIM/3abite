...
export class NotificationRetardTroisiemeNiveauEditAdminComponent extends AbstractEditController<NotificationRetardTroisiemeNiveauDto, NotificationRetardTroisiemeNiveauCriteria, NotificationRetardTroisiemeNiveauAdminService>   implements OnInit {
