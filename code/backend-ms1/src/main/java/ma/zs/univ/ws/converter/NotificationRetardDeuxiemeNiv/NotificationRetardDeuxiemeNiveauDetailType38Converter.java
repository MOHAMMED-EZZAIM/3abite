...
@Component
public class NotificationRetardDeuxiemeNiveauDetailType38Converter extends AbstractConverter<NotificationRetardDeuxiemeNiveauDetailType38, NotificationRetardDeuxiemeNiveauDetailType38Dto> {
    ...
    public  NotificationRetardDeuxiemeNiveauDetailType38Converter() {
        super(NotificationRetardDeuxiemeNiveauDetailType38.class, NotificationRetardDeuxiemeNiveauDetailType38Dto.class);
        init(true);
    }
